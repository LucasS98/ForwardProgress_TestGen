...
{
ADT_EXCEPTION__NONE CAESAR_ADT_0;
memset ((void *) (&CAESAR_ADT_0), 0, sizeof (ADT_EXCEPTION__NONE));
...
/* sort EXCEPTION__NONE is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of EXCEPTION__NONE by defining two macros CAESAR_ADT_ITR_FIRST_ADT_EXCEPTION__NONE() and CAESAR_ADT_ITR_NEXT_ADT_EXCEPTION__NONE() in file "test_0_hsa.t" */
...
/* sort INSTRUCTION is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of INSTRUCTION by defining two macros CAESAR_ADT_ITR_FIRST_INSTRUCTION() and CAESAR_ADT_ITR_NEXT_INSTRUCTION() in file "test_0_hsa.t" */
...
/* sort PROGRAM is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of PROGRAM by defining two macros CAESAR_ADT_ITR_FIRST_PROGRAM() and CAESAR_ADT_ITR_NEXT_PROGRAM() in file "test_0_hsa.t" */
...
/* sort MEMARRAY is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of MEMARRAY by defining two macros CAESAR_ADT_ITR_FIRST_MEMARRAY() and CAESAR_ADT_ITR_NEXT_MEMARRAY() in file "test_0_hsa.t" */
...
/* sort NATSET is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of NATSET by defining two macros CAESAR_ADT_ITR_FIRST_NATSET() and CAESAR_ADT_ITR_NEXT_NATSET() in file "test_0_hsa.t" */
...
#define CAESAR_ADT_FUNC_CHECK__CHANNEL__EXCHAN(CAESAR_ADT_1, CAESAR_ADT_2, CAESAR_ADT_3, CAESAR_ADT_4) (CAESAR_ADT_USE (CAESAR_ADT_4), CAESAR_ADT_USE (CAESAR_ADT_3), CAESAR_ADT_USE (CAESAR_ADT_2), CAESAR_ADT_USE (CAESAR_ADT_1), ADT_TRUE ())
