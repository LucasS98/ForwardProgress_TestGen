...
typedef unsigned char CAESAR_ADT_TYPE_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE;

#define CAESAR_ADT_SCALAR_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE

#ifndef lint
#define CAESAR_ADT_BITS_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE : 1
#endif
...
#define COMPUTE__CASE__BRANCH__1__THREAD__86__CODE__0() ((CAESAR_ADT_TYPE_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE) CAESAR_ADT_SINGLETON)

/* ------------------------------------------------------------------------- */

#define CAESAR_ADT_MATCH_COMPUTE__CASE__BRANCH__1__THREAD__86__CODE__0(CAESAR_ADT_0) (CAESAR_ADT_USE (CAESAR_ADT_0), 1)

/* ------------------------------------------------------------------------- */

#define CAESAR_ADT_CMP_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE(CAESAR_ADT_1,CAESAR_ADT_2) (CAESAR_ADT_USE (CAESAR_ADT_1), CAESAR_ADT_USE (CAESAR_ADT_2), 1)

/* ------------------------------------------------------------------------- */

#define CAESAR_ADT_PRT_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE(CAESAR_ADT_FILE,CAESAR_ADT_0) (CAESAR_ADT_USE (CAESAR_ADT_0), fprintf (CAESAR_ADT_FILE, "COMPUTE__CASE__BRANCH__1__THREAD__86__CODE__0"));

/* ------------------------------------------------------------------------- */

#ifndef CAESAR_ADT_ITR_FIRST_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE
#define CAESAR_ADT_ITR_FIRST_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE() (CAESAR_ADT_SINGLETON)
#endif

#ifndef CAESAR_ADT_ITR_NEXT_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE
#define CAESAR_ADT_ITR_NEXT_COMPUTE__CASE__BRANCH__1__THREAD__86__TYPE(CAESAR_ADT_0) (CAESAR_ADT_USE (CAESAR_ADT_0), 0)
#endif
...
/* sort EXCEPTION__NONE is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of EXCEPTION__NONE by defining two macros CAESAR_ADT_ITR_FIRST_ADT_EXCEPTION__NONE() and CAESAR_ADT_ITR_NEXT_ADT_EXCEPTION__NONE() in file "test_128_hsa_obe.t" */
...
if (CAESAR_ADT_0 == NULL) {
CAESAR_ADT_ALLOC (CAESAR_ADT_0, CAESAR_ADT_BODY_PROGRAM, CAESAR_ADT_TYPE_PROGRAM, "NIL [COMMON:52]", "CAESAR_ADT_FUNC_NIL__1");
#ifndef CAESAR_USE_STRUCT_ASSIGNMENT
...
{
CAESAR_ADT_TYPE_PROGRAM CAESAR_ADT_0;
CAESAR_ADT_ALLOC (CAESAR_ADT_0, CAESAR_ADT_BODY_PROGRAM, CAESAR_ADT_TYPE_PROGRAM, "CONS [COMMON:53]", "CAESAR_ADT_FUNC_CONS__1");
#ifndef CAESAR_USE_STRUCT_ASSIGNMENT
memset ((void *) &(CAESAR_ADT_STAR_PROGRAM (CAESAR_ADT_0)), 0, sizeof (CAESAR_ADT_BODY_PROGRAM));
#endif
...
/* sort PROGRAM is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of PROGRAM by defining two macros CAESAR_ADT_ITR_FIRST_PROGRAM() and CAESAR_ADT_ITR_NEXT_PROGRAM() in file "test_128_hsa_obe.t" */
...
ADT_CMP_INT (CAESAR_ADT_STAR_MEMARRAY (CAESAR_ADT_1).CAESAR_ADT_2_MEMARRAY, CAESAR_ADT_STAR_MEMARRAY (CAESAR_ADT_2).CAESAR_ADT_2_MEMARRAY) ;
}
...
ADT_PRINT_INT (CAESAR_ADT_FILE, CAESAR_ADT_STAR_MEMARRAY (CAESAR_ADT_0).CAESAR_ADT_1_MEMARRAY);
 fprintf (CAESAR_ADT_FILE, ", ");
ADT_PRINT_INT (CAESAR_ADT_FILE, CAESAR_ADT_STAR_MEMARRAY (CAESAR_ADT_0).CAESAR_ADT_2_MEMARRAY);
...
CAESAR_ADT_TYPE_MEMARRAY CAESAR_ADT_FUNC_MEMARRAY(CAESAR_ADT_1, CAESAR_ADT_2)
...
CAESAR_ADT_STAR_MEMARRAY (CAESAR_ADT_0).CAESAR_ADT_2_MEMARRAY = CAESAR_ADT_2;
return CAESAR_ADT_0;
}
...
#define CAESAR_ADT_GET_2_MEMARRAY(CAESAR_ADT_0) (CAESAR_ADT_STAR_MEMARRAY (CAESAR_ADT_0).CAESAR_ADT_2_MEMARRAY)

/* ------------------------------------------------------------------------- */

#ifndef CAESAR_ADT_ITR_FIRST_MEMARRAY
#define CAESAR_ADT_ITR_FIRST_MEMARRAY() CAESAR_ADT_FUNC_MEMARRAY (ADT_ENUM_FIRST_INT (), ADT_ENUM_FIRST_INT ())
#endif
...
{
ADT_INT CAESAR_ADT_2;
CAESAR_ADT_2 = CAESAR_ADT_GET_2_MEMARRAY (*CAESAR_ADT_0);
if (ADT_ENUM_NEXT_INT (CAESAR_ADT_2))
{
*CAESAR_ADT_0 = CAESAR_ADT_FUNC_MEMARRAY (CAESAR_ADT_GET_1_MEMARRAY (*CAESAR_ADT_0), CAESAR_ADT_2);
return 1;
}
}
{
...
{
*CAESAR_ADT_0 = CAESAR_ADT_FUNC_MEMARRAY (CAESAR_ADT_1, ADT_ENUM_FIRST_INT ());
return 1;
}
}
return 0;
...
/* sort NATSET is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of NATSET by defining two macros CAESAR_ADT_ITR_FIRST_NATSET() and CAESAR_ADT_ITR_NEXT_NATSET() in file "test_128_hsa_obe.t" */
...
/* ------------------------------------------------------------------------- */
 ...
 /* forward */ CAESAR_ADT_TYPE_MEMARRAY CAESAR_ADT_FUNC_MEMARRAY__1 ();
 ...
 /* forward */ CAESAR_ADT_TYPE_PROGRAM CAESAR_ADT_FUNC_GET__2__3 ();

ADT_NAT CAESAR_ADT_CONSTANT_NUMMEMLOC;
#define CAESAR_ADT_FUNC_NUMMEMLOC() CAESAR_ADT_CONSTANT_NUMMEMLOC
 /* forward */ ADT_STRING CAESAR_ADT_FUNC_PRINT_NATSET ();
 /* forward */ ADT_STRING CAESAR_ADT_FUNC_WHILE__COMMON__1__S ();
...
#define CAESAR_ADT_FUNC_GET__2__1(CAESAR_ADT_1) CAESAR_ADT_GET_2_MEMARRAY(CAESAR_ADT_1)
...
#define CAESAR_ADT_FUNC_GET__2__2(CAESAR_ADT_1) CAESAR_ADT_GET_2_ATOMIC_EXCH_BRANCH(CAESAR_ADT_1)
...
#define CAESAR_ADT_FUNC_CHECK__CHANNEL__EXCHAN(CAESAR_ADT_1, CAESAR_ADT_2, CAESAR_ADT_3) (CAESAR_ADT_USE (CAESAR_ADT_3), CAESAR_ADT_USE (CAESAR_ADT_2), CAESAR_ADT_USE (CAESAR_ADT_1), ADT_TRUE ())

/* ========================================================================= */

#define CAESAR_ADT_FUNC_COMPUTE__CASE__BRANCH__1__THREAD__86(CAESAR_ADT_1) COMPUTE__CASE__BRANCH__1__THREAD__86__CODE__0 ()
...
if (ADT_CMP_BOOL(ADT_LT_BIS_NAT (CAESAR_ADT_1, CAESAR_ADT_GET_1_CONS(CAESAR_ADT_2)), ADT_TRUE ()))
return CAESAR_ADT_2;
else
...
{
if (CAESAR_ADT_MATCH_NIL (CAESAR_ADT_2))
goto CAESAR_ADT_LABEL_1;
else
if (ADT_CMP_NAT(CAESAR_ADT_1, CAESAR_ADT_GET_1_CONS(CAESAR_ADT_2)))
return CAESAR_ADT_FUNC_CONS (CAESAR_ADT_1, CAESAR_ADT_GET_2_CONS(CAESAR_ADT_2));
else
if (ADT_CMP_BOOL(ADT_LT_BIS_NAT (CAESAR_ADT_1, CAESAR_ADT_GET_1_CONS(CAESAR_ADT_2)), ADT_TRUE ()))
goto CAESAR_ADT_LABEL_1;
else
return CAESAR_ADT_FUNC_CONS (CAESAR_ADT_GET_1_CONS(CAESAR_ADT_2), INSERT__NATSET__GENERATED (CAESAR_ADT_1, CAESAR_ADT_GET_2_CONS(CAESAR_ADT_2)));
CAESAR_ADT_LABEL_1 :
...
CAESAR_ADT_TYPE_MEMARRAY CAESAR_ADT_FUNC_MEMARRAY__1(CAESAR_ADT_1)
ADT_INT CAESAR_ADT_1;
{
return CAESAR_ADT_FUNC_MEMARRAY (CAESAR_ADT_1, CAESAR_ADT_1);
}
...
{
if (CAESAR_ADT_MATCH_ADT_SUCC_NAT (CAESAR_ADT_2))
if (CAESAR_ADT_MATCH_ADT_N0 (CAESAR_ADT_GET_1_ADT_SUCC_NAT(CAESAR_ADT_2)))
return CAESAR_ADT_GET_1_MEMARRAY(CAESAR_ADT_1);
else
if (CAESAR_ADT_MATCH_ADT_N0 (CAESAR_ADT_GET_1_ADT_SUCC_NAT(CAESAR_ADT_GET_1_ADT_SUCC_NAT(CAESAR_ADT_2))))
return CAESAR_ADT_GET_2_MEMARRAY(CAESAR_ADT_1);
else
CAESAR_ADT_ERROR ("ARRAY__GET [COMMON:25]", "ARRAY__GET__MEMARRAY__GENERATED");
else
CAESAR_ADT_ERROR ("ARRAY__GET [COMMON:25]", "ARRAY__GET__MEMARRAY__GENERATED");
...
if (CAESAR_ADT_MATCH_ADT_SUCC_NAT (CAESAR_ADT_2))
if (CAESAR_ADT_MATCH_ADT_N0 (CAESAR_ADT_GET_1_ADT_SUCC_NAT(CAESAR_ADT_2)))
return CAESAR_ADT_FUNC_MEMARRAY (CAESAR_ADT_3, CAESAR_ADT_GET_2_MEMARRAY(CAESAR_ADT_1));
else
if (CAESAR_ADT_MATCH_ADT_N0 (CAESAR_ADT_GET_1_ADT_SUCC_NAT(CAESAR_ADT_GET_1_ADT_SUCC_NAT(CAESAR_ADT_2))))
return CAESAR_ADT_FUNC_MEMARRAY (CAESAR_ADT_GET_1_MEMARRAY(CAESAR_ADT_1), CAESAR_ADT_3);
else
CAESAR_ADT_ERROR ("ARRAY__SET [COMMON:26]", "ARRAY__SET__MEMARRAY__GENERATED");
else
CAESAR_ADT_ERROR ("ARRAY__SET [COMMON:26]", "ARRAY__SET__MEMARRAY__GENERATED");
...
ADT_NAT CAESAR_ADT_1;
{
if (ADT_CMP_BOOL(ADT_LE_BIS_NAT (ADT_N1 (), CAESAR_ADT_1), ADT_TRUE ()) && ADT_CMP_BOOL(ADT_LE_BIS_NAT (CAESAR_ADT_1, ADT_N2 ()), ADT_TRUE ()))
return ADT_RANGE_CONSTRUCTOR__MEMLOC (CAESAR_ADT_1);
else
CAESAR_ADT_ERROR ("MEMLOC [COMMON:33]", "ADT_RANGE_CAST__MEMLOC__GENERATED");
...
CAESAR_ADT_ERROR ("ACCESS [COMMON:54]", "ADT_ACCESS__PROGRAM__GENERATED");
...
CAESAR_ADT_ERROR ("GET__1 [COMMON:56]", "CAESAR_ADT_FUNC_GET__1__5");
...
CAESAR_ADT_TYPE_PROGRAM CAESAR_ADT_FUNC_GET__2__3(CAESAR_ADT_1)
CAESAR_ADT_TYPE_PROGRAM CAESAR_ADT_1;
{
if (CAESAR_ADT_MATCH_CONS__1 (CAESAR_ADT_1))
return CAESAR_ADT_GET_2_CONS__1(CAESAR_ADT_1);
else
CAESAR_ADT_ERROR ("GET__2 [COMMON:57]", "CAESAR_ADT_FUNC_GET__2__3");
...
ADT_STRING CAESAR_ADT_FUNC_PRINT_NATSET(CAESAR_ADT_1)
CAESAR_ADT_TYPE_NATSET CAESAR_ADT_1;
{
if (ADT_CMP_BOOL(ADT_EQ_BIS_NAT (CAESAR_ADT_FUNC_LENGTH__1 (CAESAR_ADT_1), ADT_N0 ()), ADT_TRUE ()))
return ADT_STORE_STRING (ADT_CONCAT_CONST_STRING (ADT_STRING_058 (), ADT_STRING_058 ()));
else
return CAESAR_ADT_FUNC_WHILE__COMMON__1__S (ADT_N0 (), ADT_STORE_STRING (ADT_STRING_058 ()), CAESAR_ADT_1);
}
...
ADT_STRING CAESAR_ADT_FUNC_WHILE__COMMON__1__S(CAESAR_ADT_1, CAESAR_ADT_2, CAESAR_ADT_3)
ADT_NAT CAESAR_ADT_1;
ADT_STRING CAESAR_ADT_2;
CAESAR_ADT_TYPE_NATSET CAESAR_ADT_3;
{
if (ADT_CMP_BOOL(ADT_LT_BIS_NAT (CAESAR_ADT_1, ADT_N4 ()), ADT_TRUE ()) && ADT_CMP_BOOL(CAESAR_ADT_FUNC_MEMBER (CAESAR_ADT_1, CAESAR_ADT_3), ADT_TRUE ()))
return CAESAR_ADT_FUNC_WHILE__COMMON__1__S (ADT_PLUS_NAT (CAESAR_ADT_1, ADT_N1 ()), ADT_CONCAT_STRING (ADT_CONCAT_STRING (CAESAR_ADT_2, ADT_TO_STRING_NAT (CAESAR_ADT_1)), ADT_STORE_STRING (ADT_STRING_058 ())), CAESAR_ADT_3);
else
if (ADT_CMP_BOOL(ADT_LT_BIS_NAT (CAESAR_ADT_1, ADT_N4 ()), ADT_TRUE ()))
return CAESAR_ADT_FUNC_WHILE__COMMON__1__S (ADT_PLUS_NAT (CAESAR_ADT_1, ADT_N1 ()), CAESAR_ADT_2, CAESAR_ADT_3);
else
return CAESAR_ADT_2;
}
...
#endif
#ifndef CAESAR_ADT_NO_DIAGNOSIS
CAESAR_ADT_CURRENT_CONSTANT_LOTOS = "NUMMEMLOC [COMMON:60]";
CAESAR_ADT_CURRENT_CONSTANT_C = "CAESAR_ADT_FUNC_NUMMEMLOC";
#endif
CAESAR_ADT_FUNC_NUMMEMLOC() = ADT_N2 ();
#ifndef CAESAR_ADT_NO_DIAGNOSIS
