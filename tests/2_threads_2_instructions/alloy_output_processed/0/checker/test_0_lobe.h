...
/* sort EXCEPTION__NONE is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of EXCEPTION__NONE by defining two macros CAESAR_ADT_ITR_FIRST_ADT_EXCEPTION__NONE() and CAESAR_ADT_ITR_NEXT_ADT_EXCEPTION__NONE() in file "test_0_lobe.t" */
...
/* sort PROGRAM is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of PROGRAM by defining two macros CAESAR_ADT_ITR_FIRST_PROGRAM() and CAESAR_ADT_ITR_NEXT_PROGRAM() in file "test_0_lobe.t" */
...
/* sort NATSET is infinite: no iterator can be generated automatically for this sort; however, it is possible to specify manually an iterator for a finite subset of NATSET by defining two macros CAESAR_ADT_ITR_FIRST_NATSET() and CAESAR_ADT_ITR_NEXT_NATSET() in file "test_0_lobe.t" */
